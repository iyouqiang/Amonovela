...
class FCPersonalDataController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.loginOutBtn.titleLabel?.font = UIFont(_PingFangSCTypeSize: 18)
...
extension FCPersonalDataController : UITableViewDataSource, UITableViewDelegate { 
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if cell == nil {
            ...
            cell?.textLabel?.font = UIFont(_PingFangSCTypeSize: 18)
            cell?.detailTextLabel?.font = UIFont(_PingFangSCTypeSize: 18)
        }
