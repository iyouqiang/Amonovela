...
class FCCXPMentionCoinSubView: UIView {
    ...
    override func awakeFromNib() {
        ...
        mentionAddressTextfield.attributedPlaceholder = NSAttributedString.init(string: "输入或长按张贴地址", attributes: [NSAttributedString.Key.font:UIFont(_PingFangSCTypeSize: 14),NSAttributedString.Key.foregroundColor:COLOR_HexColor(0x6A6A6E)])
        mentionNumTextfield.attributedPlaceholder = NSAttributedString.init(string: "最小提币数量2", attributes: [NSAttributedString.Key.font:UIFont(_PingFangSCTypeSize: 14),NSAttributedString.Key.foregroundColor:COLOR_HexColor(0x6A6A6E)])
