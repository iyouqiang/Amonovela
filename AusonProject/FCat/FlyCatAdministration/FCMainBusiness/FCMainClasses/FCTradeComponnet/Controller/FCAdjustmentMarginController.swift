...
class FCAdjustmentMarginController: UIViewController, UIGestureRecognizerDelegate {
    ...
    func setUpView() {
        ...
        /// 增加额 平仓额
        maximumL = fc_labelInit(text: "最多增加：0.00", textColor: COLOR_TabBarTintColor, textFont: UIFont(_PingFangSCTypeSize: 14), bgColor: .clear)
        ...
        closePositionL = fc_labelInit(text: "追加后强平价格为：0.00", textColor: COLOR_TabBarTintColor, textFont: UIFont(_PingFangSCTypeSize: 14), bgColor: .clear)
        ...
        sliderContainerView.backgroundColor = COLOR_BGColor
        longShortDirectL = fc_labelInit(text: "BTCUSDT永续 多头方向", textColor: COLOR_InputText, textFont: UIFont(_PingFangSCTypeSize: 14), bgColor: .clear)
        ...
        /// 杠杆水平
        startValueL = fc_labelInit(text: "0", textColor: COLOR_InputText, textFont: UIFont(_PingFangSCTypeSize: 14), bgColor: .clear)
        sliderContainerView.addSubview(startValueL)
        
        endValueL = fc_labelInit(text: "100", textColor: COLOR_InputText, textFont: UIFont(_PingFangSCTypeSize: 14), bgColor: .clear)
